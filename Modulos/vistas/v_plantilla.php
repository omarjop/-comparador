...
<head>
  ...
  <link rel="stylesheet" href="vistas/css/recetas.css">
...
<?php 
    ...
    if(isset($_GET['ruta'])){
              ...
              $_GET['ruta'] == "addTipoEmpresa" || $_GET['ruta'] == "addTipoProducto"|| $_GET['ruta'] == "addCategorias"|| $_GET['ruta'] == "addPais"|| $_GET['ruta'] == "addPerfil"|| $_GET['ruta'] == "addCiudad"||  $_GET['ruta'] == "addDia"||  $_GET['ruta'] == "addTipoPago"||$_GET['ruta'] == "addPesoVolum"||$_GET['ruta'] == "addDificultad"||$_GET['ruta'] == "addSubCategoria"||$_GET['ruta'] == "addPersona"||$_GET['ruta'] == "addUsuario"||$_GET['ruta'] == "addRecetas"||$_GET['ruta'] == "addNewProductAdmin")&& $tipoUser == 2){ 
