...
require_once "conexion.php";
 ...
 class ModeloUsuarios{
    ...
    static public function mdlRegistroUsuario($tabla , $datos){
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(Perfil_idPerfil, correo, Clave, verificar, modoAcceso, emailEncriptado)
                 VALUES  (:Perfil_idPerfil, :correo, :Clave, :verificar, :modoAcceso , :emailEncriptado)");
