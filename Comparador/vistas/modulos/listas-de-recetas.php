...
<div class="container-fluid">
    <div class="container">
       ...
       <!---========================================  
        LISTAS DE RECETAS style="display:none"
        ===========================================-->
        <div class="listasRecetasR" id="recargaLista">
                ...
                <?php  
                    if(isset($_SESSION["id"])){
                        ...
                        <li>
                            ...
                            <button type="button" class="btn backColor"><i class="fa fa-sign-in"></i> Crear Lista</button>
